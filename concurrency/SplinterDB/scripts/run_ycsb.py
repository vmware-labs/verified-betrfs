...
CL_PARSER.add_argument('--ironsync', action="store_true")
...
for mem in MEM_SIZES:
    for thread_count in THREAD_COUNTS:
        ...
        with open(ycsb_csv_name, "w") as ycsb_csv:
            if DEVICE:
                ycsb_csv.write(
                    "Workload Throughput ReadAmp WriteAmp\n")
            else:
                ycsb_csv.write("Workload Throughput\n")
            ...
            for i, trace_filename in enumerate(TRACE_FILENAMES):
                ...
                if (IRONSYNC):
                    run_command = ["./bin/veri_driver_test", "ycsb_test"]
                else:
                ...
                if DEVICE:
                    ycsb_csv.write("{} {} {} {}\n".format(
                        workload_name, throughput, read_amp, write_amp))
                else:
                    ycsb_csv.write("{} {}\n".format(workload_name, throughput))
