...
/**
 * Ported from https://github.com/sslab-gatech/shfllock
 */
...
// TODO(stutsman) Integrate topology.h from LiTL to set these correctly.
#define NUMA_NODES                        4
#define CPU_NUMBER                        192
...
void aqs_mutex_set_cur_thread_id(uint32_t thread_id) {
