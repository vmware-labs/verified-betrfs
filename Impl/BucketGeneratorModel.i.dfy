...
module BucketGeneratorModel {
  ...
  lemma {:timeLimitMultiplier 3} GenFromBucketWithLowerBoundYieldsClampStart(bucket: Bucket, start: UI.RangeStart, pset: Option<PrefixSet>)
  requires WFBucket(bucket)
  ...
  lemma{:induction true} {:timeLimitMultiplier 3} GenFromBucketStackWithLowerBoundYieldsComposeSeq(buckets: seq<Bucket>, start: UI.RangeStart, tt: TranslationTable)
