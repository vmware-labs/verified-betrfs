...
module {:extern "MainDiskIOHandler"} MainDiskIOHandler {
  import opened NativeTypes
  import D = AsyncDisk

  class {:extern} DiskIOHandler {
    method {:extern "MainDiskIOHandler", "write"} 
    ...
    method {:extern "MainDiskIOHandler", "read"} 
