...
module PackedInts {
  ...
  method {:axiom} Unpack_LittleEndian_Uint32(packed: seq<byte>, idx: uint64)
  returns (i: uint32)
  requires 0 <= idx
  requires idx as int + 4 <= |packed|
  ensures i == unpack_LittleEndian_Uint32(packed[idx .. idx + 4])

  method {:axiom} Unpack_LittleEndian_Uint64(packed: seq<byte>, idx: uint64)
  returns (i: uint64)
  requires 0 <= idx
  requires idx as int + 8 <= |packed|
  ensures i == unpack_LittleEndian_Uint64(packed[idx .. idx + 8])

  method {:axiom} Pack_LittleEndian_Uint32_into_Array(i: uint32, ar: array<byte>, idx: uint64)
  requires 0 <= idx
  ...
  method {:axiom} Pack_LittleEndian_Uint64_into_Array(i: uint64, ar: array<byte>, idx: uint64)
  requires 0 <= idx
  ...
  method {:axiom} Unpack_LittleEndian_Uint32_Seq(packed: seq<byte>, idx: uint64, len: uint64)
  ...
  method {:axiom} Unpack_LittleEndian_Uint64_Seq(packed: seq<byte>, idx: uint64, len: uint64)
  ...
  method {:axiom} Pack_LittleEndian_Uint32_Seq_into_Array(unpacked: seq<uint32>, ar: array<byte>, idx: uint64)
  requires 0 <= idx
  ...
  method {:axiom} Pack_LittleEndian_Uint64_Seq_into_Array(unpacked: seq<uint64>, ar: array<byte>, idx: uint64)
  requires 0 <= idx
