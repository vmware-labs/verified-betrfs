...
build/roslyn-veribetrfs.exe: $(FRAMEWORK_SOURCES) $(BUNDLE_SOURCE)
	./tools/roslyn-csc.sh -langversion:8.0 $(BUNDLE_SOURCE) $(FRAMEWORK_SOURCES) /r:tools/System.Memory.dll /optimize /nowarn:CS0162 /nowarn:CS0164 /unsafe /t:exe /out:build/roslyn-veribetrfs.exe
