...
abstract module BetreeBlockCacheSystemCrashSafeBetreeRefinement {
  ...
  lemma RefinesBetreeMoveStep(k: BBCS.Constants, s: BBCS.Variables, s': BBCS.Variables, uiop: UIOp, dop: DiskOp, betreeStep: BetreeStep)
  requires BBCS.Inv(k, s)
  requires BBCS.Inv(k, s')
  ...
  ensures CSBT.Next(Ik(k), I(k, s), I(k, s'), uiop)
  {
    ...
    assert CSBT.NextStep(Ik(k), I(k, s), I(k, s'), uiop, CSBT.EphemeralMoveStep);
  }
  ...
  lemma RefinesWriteBackStep(k: BBCS.Constants, s: BBCS.Variables, s': BBCS.Variables, uiop: UIOp, dop: DiskOp, ref: Reference)
  requires BBCS.Inv(k, s)
  requires BBCS.Inv(k, s')
  requires uiop.NoOp?
  ...
  lemma RefinesWriteBackSuperblockStep(k: BBCS.Constants, s: BBCS.Variables, s': BBCS.Variables, uiop: UIOp, dop: DiskOp)
  requires BBCS.Inv(k, s)
  requires BBCS.Inv(k, s')
  requires uiop.NoOp?
  ...
  ensures CSBT.Next(Ik(k), I(k, s), I(k, s'), uiop)
  {
    ...
    assert CSBT.NextStep(Ik(k), I(k, s), I(k, s'), uiop, CSBT.SyncStep);
  }

  lemma RefinesUnallocStep(k: BBCS.Constants, s: BBCS.Variables, s': BBCS.Variables, uiop: UIOp, dop: DiskOp, ref: Reference)
  requires BBCS.Inv(k, s)
  requires BBCS.Inv(k, s')
  requires uiop.NoOp?
  ...
  lemma RefinesPageInStep(k: BBCS.Constants, s: BBCS.Variables, s': BBCS.Variables, uiop: UIOp, dop: DiskOp, ref: Reference)
  requires BBCS.Inv(k, s)
  requires BBCS.Inv(k, s')
  requires uiop.NoOp?
  ...
  lemma RefinesPageInSuperblockStep(k: BBCS.Constants, s: BBCS.Variables, s': BBCS.Variables, uiop: UIOp, dop: DiskOp)
  requires BBCS.Inv(k, s)
  requires BBCS.Inv(k, s')
  requires uiop.NoOp?
  ...
  lemma RefinesEvictStep(k: BBCS.Constants, s: BBCS.Variables, s': BBCS.Variables, uiop: UIOp, dop: DiskOp, ref: Reference)
  requires BBCS.Inv(k, s)
  requires BBCS.Inv(k, s')
  requires uiop.NoOp?
  ...
  lemma RefinesBlockCacheMoveStep(k: BBCS.Constants, s: BBCS.Variables, s': BBCS.Variables, uiop: UIOp, dop: DiskOp, step: BC.Step)
  requires BBCS.Inv(k, s)
  requires BBCS.Inv(k, s')
  requires uiop.NoOp?
  ...
  lemma RefinesMachineStep(k: BBCS.Constants, s: BBCS.Variables, s': BBCS.Variables, uiop: UIOp, dop: DiskOp, step: M.Step)
  requires BBCS.Inv(k, s)
  requires BBCS.Inv(k, s')
  ...
  lemma RefinesMachine(k: BBCS.Constants, s: BBCS.Variables, s': BBCS.Variables, uiop: UIOp, dop: DiskOp)
  requires BBCS.Inv(k, s)
  requires BBCS.Inv(k, s')
  ...
  lemma RefinesCrash(k: BBCS.Constants, s: BBCS.Variables, s': BBCS.Variables, uiop: UIOp)
  requires BBCS.Inv(k, s)
  requires BBCS.Inv(k, s')
  ...
  lemma RefinesNextStep(k: BBCS.Constants, s: BBCS.Variables, s': BBCS.Variables, uiop: UIOp, step: BBCS.Step)
  requires BBCS.Inv(k, s)
  ...
  ensures CSBT.Next(Ik(k), I(k, s), I(k, s'), uiop)
  {
    ...
    match step {
      case MachineStep(dop) => RefinesMachine(k, s, s', uiop, dop);
