...
module BetreeBlockCacheSystem_Refines_CrashSafePivotBetree {
  import opened Maps
  ...
  lemma RefinesNoOpStep(k: BBCS.Constants, s: BBCS.Variables, s': BBCS.Variables, uiop: M.UIOp, dop: DiskOp)
  requires BBCS.Inv(k, s)
  requires BBCS.Inv(k, s')
  requires uiop.NoOp?
