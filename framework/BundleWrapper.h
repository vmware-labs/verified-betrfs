...
bool handle_Insert(Constants, Variables, shared_ptr<MainDiskIOHandler_Compile::DiskIOHandler>, Key const&, DafnySequence<uint8>);
std::pair<bool, DafnySequence<uint8>> handle_Query(Constants, Variables, shared_ptr<MainDiskIOHandler_Compile::DiskIOHandler>, Key const&);
