...
def main():
  ...
  cmd = "g++ -O3 lib/DataStructures/lib/DataStructures/MutableBtree.i.cpp -o MutableBtreeTest -I .dafny/dafny/Binaries/ -I lib/DataStructures/ -Ilib -std=c++17 -I. -Iframework framework/NativeArrays.cpp"
  actuallyprint(cmd)
  ret = os.system(cmd)
  assert ret == 0
