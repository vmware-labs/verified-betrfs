...
def main():
  ...
  if branch == "eval-btree-linear":
    dafny_cmd = ".dafny/dafny/Binaries/dafny /noVerify /spillTargetCode:3 /countVerificationErrors:0 /compileTarget:cpp lib/DataStructures/MutableBtree.i.dfy Lang/LinearExtern.h framework/Framework.h framework/LinearCongruentialGenerator.h"
  ...
  if branch == "eval-btree-master":
    ...
    cmd = "g++ -O3 lib/DataStructures/lib/DataStructures/MutableBtree.i.cpp bench/run-mutable-btree.cpp -o MutableBtreeBench -I .dafny/dafny/Binaries/ -I lib/DataStructures/ -Ilib -std=c++17 -I. framework/LinearCongruentialGenerator.h"
  actuallyprint(cmd)
  ret = os.system(cmd)
  assert ret == 0
