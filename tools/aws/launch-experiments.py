...
common_vars = [
    Variable("infrastructure_branch", "infrastructure", [Value("aws-tweaks", "aws-tweaks")]),
...
veri_suite = Suite(
    ...
    Variable("git_branch", "run_veri", [Value("row-cache-adventure", "row-cache-adventure")]),
...
#    *common_vars)
suite = ConcatSuite("row-cache-015", veri_suite)
